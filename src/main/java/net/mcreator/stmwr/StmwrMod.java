...
import net.mcreator.stmwr.init.StmwrModParticleTypes;
...
@Mod("stmwr")
public class StmwrMod {
	public static final Logger LOGGER = LogManager.getLogger(StmwrMod.class);
	public static final String MODID = "stmwr";
	...
	public StmwrMod() {
		...
		StmwrModParticleTypes.REGISTRY.register(bus);

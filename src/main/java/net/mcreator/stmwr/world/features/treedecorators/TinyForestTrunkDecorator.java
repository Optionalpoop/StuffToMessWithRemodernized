...
public class TinyForestTrunkDecorator extends TrunkVineDecorator {
	public static Codec<TinyForestTrunkDecorator> CODEC = Codec.unit(TinyForestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("tiny_forest_tree_trunk_decorator", DECORATOR_TYPE));
	}

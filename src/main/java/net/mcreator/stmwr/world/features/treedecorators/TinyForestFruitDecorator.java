...
package net.mcreator.stmwr.world.features.treedecorators;
...
public class TinyForestFruitDecorator extends CocoaDecorator {
	public static Codec<TinyForestFruitDecorator> CODEC = Codec.unit(TinyForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("tiny_forest_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public TinyForestFruitDecorator() {
		super(0.2f);
	}

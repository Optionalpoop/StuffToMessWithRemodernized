...
public class BasicCubbyPackGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BasicCubbyPackGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(StmwrModMenus.BASIC_CUBBY_PACK_GUI.get(), id);

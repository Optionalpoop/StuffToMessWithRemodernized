...
public class ModifiersTableMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ModifiersTableMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(StmwrModMenus.MODIFIERS_TABLE.get(), id);

...
public class GrimaceRenderer extends HumanoidMobRenderer<GrimaceEntity, HumanoidModel<GrimaceEntity>> {
	...
	public ResourceLocation getTextureLocation(GrimaceEntity entity) {
		return new ResourceLocation("stmwr:textures/entities/grimace.png");
	}
}

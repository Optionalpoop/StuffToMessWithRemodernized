...
public class RonaldMCDonaldRenderer extends HumanoidMobRenderer<RonaldMCDonaldEntity, HumanoidModel<RonaldMCDonaldEntity>> {
	public RonaldMCDonaldRenderer(EntityRendererProvider.Context context) {

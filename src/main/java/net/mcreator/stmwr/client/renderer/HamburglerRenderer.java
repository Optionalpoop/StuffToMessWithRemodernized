...
public class HamburglerRenderer extends HumanoidMobRenderer<HamburglerEntity, HumanoidModel<HamburglerEntity>> {
	public HamburglerRenderer(EntityRendererProvider.Context context) {

...
import net.mcreator.stmwr.network.ModifiersTableButtonMessage;
...
public class ModifiersTableScreen extends AbstractContainerScreen<ModifiersTableMenu> {
	private final static HashMap<String, Object> guistate = ModifiersTableMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	Button button_confirm;

	public ModifiersTableScreen(ModifiersTableMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("stmwr:textures/screens/modifiers_table.png");

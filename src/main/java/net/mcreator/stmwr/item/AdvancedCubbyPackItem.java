...
import net.mcreator.stmwr.item.inventory.AdvancedCubbyPackInventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class AdvancedCubbyPackItem extends Item {
	public AdvancedCubbyPackItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Advanced Cubby Pack");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new AdvancedCubbyPackGUIMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new AdvancedCubbyPackInventoryCapability();
	}

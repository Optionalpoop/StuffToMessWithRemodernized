...
import net.mcreator.stmwr.procedures.SteelArmorTickEventProcedure;
...
public abstract class SteelArmorItem extends ArmorItem {
	...
	public static class Helmet extends SteelArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "stmwr:textures/models/armor/steel_layer_1.png";
		}
		...
		public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
			...
			if (entity instanceof Player player && Iterables.contains(player.getArmorSlots(), itemstack)) {
				SteelArmorTickEventProcedure.execute(entity);
			}
		}
	}
	...
	public static class Leggings extends SteelArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "stmwr:textures/models/armor/steel_layer_2.png";
		}

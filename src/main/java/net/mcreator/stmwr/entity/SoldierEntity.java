...
public class SoldierEntity extends PathfinderMob {
	public SoldierEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StmwrModEntities.SOLDIER.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(StmwrModItems.ADVANCED_MATERIAL.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(StmwrModEntities.SOLDIER.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}

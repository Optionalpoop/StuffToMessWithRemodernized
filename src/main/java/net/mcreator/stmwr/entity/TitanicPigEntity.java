...
public class TitanicPigEntity extends Monster {
	public TitanicPigEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StmwrModEntities.TITANIC_PIG.get(), world);
	}

	public TitanicPigEntity(EntityType<TitanicPigEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(50f);
		xpReward = 40;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(StmwrModItems.TITANIC_STRING.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(StmwrModEntities.TITANIC_PIG.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}

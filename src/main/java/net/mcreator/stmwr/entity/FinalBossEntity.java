...
public class FinalBossEntity extends Monster {
	...
	public FinalBossEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StmwrModEntities.FINAL_BOSS.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(StmwrModItems.INFINITITE_MOLD.get()));
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		FinalBossEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}

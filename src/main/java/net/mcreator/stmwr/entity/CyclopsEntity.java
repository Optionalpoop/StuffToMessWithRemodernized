...
public class CyclopsEntity extends Monster {
	...
	public CyclopsEntity(EntityType<CyclopsEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(100f);
		xpReward = 500;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(StmwrModItems.TITAN_BONE.get()));
	}
	...
	public EntityDimensions getDimensions(Pose pose) {
		return super.getDimensions(pose).scale(15f);
	}

...
public class InfinityGolemEntity extends Monster {
	public InfinityGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StmwrModEntities.INFINITY_GOLEM.get(), world);
	}

	public InfinityGolemEntity(EntityType<InfinityGolemEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(5f);
		xpReward = 1000;
		setNoAi(false);

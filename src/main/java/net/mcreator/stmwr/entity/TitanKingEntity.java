...
public class TitanKingEntity extends Monster {
	...
	public TitanKingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StmwrModEntities.TITAN_KING.get(), world);
	}

	public TitanKingEntity(EntityType<TitanKingEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(50f);
		xpReward = 1000;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(StmwrModItems.TITANIC_EYE.get()));
	}

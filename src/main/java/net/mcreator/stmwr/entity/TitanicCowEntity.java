...
public class TitanicCowEntity extends Monster {
	public TitanicCowEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StmwrModEntities.TITANIC_COW.get(), world);
	}

	public TitanicCowEntity(EntityType<TitanicCowEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(50f);
		xpReward = 40;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(StmwrModItems.TITANIC_LEATHER.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(StmwrModEntities.TITANIC_COW.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}

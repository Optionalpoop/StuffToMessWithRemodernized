...
public class StmwrModTabs {
	...
	public static final RegistryObject<CreativeModeTab> STMW_5 = REGISTRY.register("stmw_5",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.stmwr.stmw_5")).icon(() -> new ItemStack(StmwrModBlocks.INFINITITE_BLOCK.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(StmwrModItems.CYCLOPS_ENRAGER.get());
				tabData.accept(StmwrModItems.GIGANTUM_INGOT.get());
	...
	public static final RegistryObject<CreativeModeTab> STMWR_FOODS = REGISTRY.register("stmwr_foods",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.stmwr.stmwr_foods")).icon(() -> new ItemStack(StmwrModItems.PIZZA.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(StmwrModItems.HOT_DOG_BUN.get());
				tabData.accept(StmwrModItems.BURGER_BUN.get());
				tabData.accept(StmwrModItems.HOT_DOG.get());
	...
	public static final RegistryObject<CreativeModeTab> STMWR_CRATES = REGISTRY.register("stmwr_crates",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.stmwr.stmwr_crates")).icon(() -> new ItemStack(StmwrModBlocks.GENERIC_CRATE_BLOCK.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(StmwrModBlocks.GENERIC_CRATE_BLOCK.get().asItem());
			})

					.build());
	public static final RegistryObject<CreativeModeTab> STMWR_GEAR = REGISTRY.register("stmwr_gear",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.stmwr.stmwr_gear")).icon(() -> new ItemStack(StmwrModItems.INFINITITE_ARMOR_CHESTPLATE.get())).displayItems((parameters, tabData) -> {
	...
	public static final RegistryObject<CreativeModeTab> STMWR_TOTEMS = REGISTRY.register("stmwr_totems",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.stmwr.stmwr_totems")).icon(() -> new ItemStack(StmwrModItems.RAW_TOTEM.get())).displayItems((parameters, tabData) -> {

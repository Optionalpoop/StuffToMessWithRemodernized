...
import net.mcreator.stmwr.item.WizardWorldAmbienceItem;
...
import net.mcreator.stmwr.item.WandOfSlowingItem;
import net.mcreator.stmwr.item.WandOfSaturationItem;
...
import net.mcreator.stmwr.item.TitanWorldAmbienceItem;
import net.mcreator.stmwr.item.TitanSummonItem;
import net.mcreator.stmwr.item.TitanKingMusicItem;
...
import net.mcreator.stmwr.item.SteveCowLandAmbienceItem;
...
import net.mcreator.stmwr.item.SpellBookOfSlowingItem;
import net.mcreator.stmwr.item.SpellBookOfSaturationItem;
...
import net.mcreator.stmwr.item.SmallWorldAmbienceItem;
...
import net.mcreator.stmwr.item.MutantMusicItem;
...
import net.mcreator.stmwr.item.MilitariaAmbienceItem;
...
import net.mcreator.stmwr.item.GigantumIngotItem;
import net.mcreator.stmwr.item.GiantSteveCowHeartItem;
import net.mcreator.stmwr.item.GiantStevECowMusicItem;
...
import net.mcreator.stmwr.item.FinalBossMusicItem;
import net.mcreator.stmwr.item.EmptySpellBookItem;
import net.mcreator.stmwr.item.EmptyPlainsItem;
import net.mcreator.stmwr.item.EmptyPlainsAmbienceItem;
...
import net.mcreator.stmwr.item.CheeseBurgerItem;
...
public class StmwrModItems {
	...
	public static final RegistryObject<Item> SPELL_BOOK_OF_SATURATION = REGISTRY.register("spell_book_of_saturation", () -> new SpellBookOfSaturationItem());
	public static final RegistryObject<Item> WAND_OF_SATURATION = REGISTRY.register("wand_of_saturation", () -> new WandOfSaturationItem());
	public static final RegistryObject<Item> CHICKEN_NUGGET = REGISTRY.register("chicken_nugget", () -> new ChickenNuggetItem());
	public static final RegistryObject<Item> HAMBURGLER_SPAWN_EGG = REGISTRY.register("hamburgler_spawn_egg", () -> new ForgeSpawnEggItem(StmwrModEntities.HAMBURGLER, -6711040, -16738048, new Item.Properties()));
	public static final RegistryObject<Item> MC_DONALDS_EMPLOYEE_SPAWN_EGG = REGISTRY.register("mc_donalds_employee_spawn_egg", () -> new ForgeSpawnEggItem(StmwrModEntities.MC_DONALDS_EMPLOYEE, -6711040, -154, new Item.Properties()));
	public static final RegistryObject<Item> RONALD_MC_DONALD_SPAWN_EGG = REGISTRY.register("ronald_mc_donald_spawn_egg", () -> new ForgeSpawnEggItem(StmwrModEntities.RONALD_MC_DONALD, -3407821, -103, new Item.Properties()));
	public static final RegistryObject<Item> GRIMACE_SPAWN_EGG = REGISTRY.register("grimace_spawn_egg", () -> new ForgeSpawnEggItem(StmwrModEntities.GRIMACE, -10092442, -3407617, new Item.Properties()));
	public static final RegistryObject<Item> EMPTY_PLAINS = REGISTRY.register("empty_plains", () -> new EmptyPlainsItem());
	public static final RegistryObject<Item> SPELL_BOOK_OF_SLOWING = REGISTRY.register("spell_book_of_slowing", () -> new SpellBookOfSlowingItem());
	...
	public static final RegistryObject<Item> GENERIC_CRATE_BLOCK = block(StmwrModBlocks.GENERIC_CRATE_BLOCK);
	public static final RegistryObject<Item> CYCLOPS_ENRAGER = REGISTRY.register("cyclops_enrager", () -> new CyclopsEnragerItem());
	public static final RegistryObject<Item> GIGANTUM_INGOT = REGISTRY.register("gigantum_ingot", () -> new GigantumIngotItem());
	public static final RegistryObject<Item> GIGANTUM_ORE = block(StmwrModBlocks.GIGANTUM_ORE);
	public static final RegistryObject<Item> GIGANTUM_BLOCK = block(StmwrModBlocks.GIGANTUM_BLOCK);
	public static final RegistryObject<Item> HOT_DOG_BUN = REGISTRY.register("hot_dog_bun", () -> new HotDogBunItem());
	public static final RegistryObject<Item> BURGER_BUN = REGISTRY.register("burger_bun", () -> new BurgerBunItem());
	public static final RegistryObject<Item> HOT_DOG = REGISTRY.register("hot_dog", () -> new HotDogItem());
	public static final RegistryObject<Item> RAW_PATTY = REGISTRY.register("raw_patty", () -> new RawPattyItem());
	...
	public static final RegistryObject<Item> EMPTY_PLAINS_AMBIENCE = REGISTRY.register("empty_plains_ambience", () -> new EmptyPlainsAmbienceItem());
	public static final RegistryObject<Item> SMALL_WORLD_AMBIENCE = REGISTRY.register("small_world_ambience", () -> new SmallWorldAmbienceItem());
	public static final RegistryObject<Item> TITAN_WORLD_AMBIENCE = REGISTRY.register("titan_world_ambience", () -> new TitanWorldAmbienceItem());
	public static final RegistryObject<Item> WIZARD_WORLD_AMBIENCE = REGISTRY.register("wizard_world_ambience", () -> new WizardWorldAmbienceItem());
	public static final RegistryObject<Item> STEVE_COW_LAND_AMBIENCE = REGISTRY.register("steve_cow_land_ambience", () -> new SteveCowLandAmbienceItem());
	public static final RegistryObject<Item> FINAL_BOSS_MUSIC = REGISTRY.register("final_boss_music", () -> new FinalBossMusicItem());
	public static final RegistryObject<Item> GIANT_STEV_E_COW_MUSIC = REGISTRY.register("giant_stev_e_cow_music", () -> new GiantStevECowMusicItem());
